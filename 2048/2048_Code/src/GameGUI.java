...
public class GameGUI extends JFrame{
    private final JPanel mainpanel = new JPanel();                                //Main game panel//
    private final JPanel panel1 = new JPanel();                                   //Title "2048" panel//
    private final JPanel panel2 = new JPanel();                                   //Game box panel//
    private final JPanel highscorePanel = new JPanel();                           //High score panel//
    private final JPanel undoRedoPanel = new JPanel();                            //Undo/Redo panel//
    ...
    public GameGUI() throws HeadlessException {
        ...
        undoRedoPanel.setBorder(BorderFactory.createMatteBorder(5,2,5,2,Color.gray.darker()));
        ...
        JLabel sig = new JLabel("                          "
                + "a game project by Nguyễn Anh Dũng - ITITIU17073");
        layoutconstraints.gridx=0;
        layoutconstraints.ipady=0;
        layoutconstraints.gridy=2;
        mainpanel.add(sig,layoutconstraints);
        
        //Add all of them to get our final game design//
        add(mainpanel);
    }
}
